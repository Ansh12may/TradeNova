        ...
        <div className='container border-top mt-5'>
            <div className='row mt-5'>
                ...
                <div className='col'>
                    ...
                    <br/>
                    <a href='' className="text-decoration-none text-dark">Philosophy</a>
                    <br/>
                ...
                <div className='col'>
                    ...
                    <br/>
                    <a href='' className="text-decoration-none text-dark">Downloads and resources</a>
                    <br/>
                </div>
                <div className='col'>
                    <p>Account</p>
                    ...
                    <br/>
                    <a href='' className="text-decoration-none text-dark">60 days challenge</a>
                    <br/>
                </div>
            </div>
